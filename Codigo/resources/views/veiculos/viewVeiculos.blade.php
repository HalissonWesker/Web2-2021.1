   ...
   <div class="menu">
      ...
      <tbody>
         ...
         @foreach ($veiculo as $veicu)<tr>
            ...
            <td>
                                <a class="btn btn-warning" href="/atualizarVeiculo/{{$veicu->id}}" role="button">Editar</a>
                                <a class="btn btn-danger" onclick="return confirm('Quer mesmo deletar? A ação não poderá ser desfeita');" href="/apagarVeiculo/{{$veicu->id}}" role="button">Apagar</a>
            </td>
