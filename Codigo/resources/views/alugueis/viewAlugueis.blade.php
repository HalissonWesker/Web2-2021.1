...
<div class="container ">
   ...
   <div class="menu">
           <div class="botoesmenu"> <a href="/" class="btn btn-sm btn-danger">Voltar</a><br><br>
            <a href="/CadastroAluguel" class="btn btn-sm btn-primary">Realizar Aluguel</a><br>
</div>
      ...
      <tbody>
         <tr>
            ...
            <td>{{$alu['modelo']}}</td>      
            <td>
                                <a class="btn btn-warning" href="/atualizarAluguel/{{$alu['id']}}" role="button">Editar</a>
                                <a class="btn btn-danger" onclick="return confirm('Quer mesmo deletar? A ação não poderá ser desfeita');" href="/apagarAluguel/{{$alu['id']}}" role="button">Apagar</a>
            </td>
         </tr>
         @endforeach
